...
import { OffsetPaginationResponse } from '@/types';
 ...
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/OffsetPaginationResponse'
 *       500:
 *         description: 서버 에러
 *         content:
 *           application/json:
...
export async function GET(
  request: NextRequest
): Promise<NextResponse<OffsetPaginationResponse> | NextResponse<{ error: string }>> {
  try {
